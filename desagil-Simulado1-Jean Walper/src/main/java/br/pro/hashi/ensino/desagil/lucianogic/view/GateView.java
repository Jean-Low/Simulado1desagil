...
public class GateView extends FixedPanel implements ActionListener {
	...
	private boolean in1,in2,sel;

	//private Lavanca lavanca1,lavanca2;
	...
	public void paintComponent(Graphics g) {
		...
		for (int i = 0; i < size;i ++){
			g.fillOval(22, 50 + i * 40, 15, 15);
			g.drawLine(27, 60+ i * 40, on[i] ? 10:40, 40+ i * 40 );
			g.fillOval(on[i] ? 8:38 , 37+ i * 40, 5, 5);
